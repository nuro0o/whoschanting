...
- **Soul Bind:** break alternating ring and tower seals. Level 1 has three quick seals with two rings (one turn each) or three clearly different towers. Level 2 has two moderate seals with three rings or four towers. Level 3 has one complex seal with five rings or six towers. Keyboard controls offer the same actions.
- **Mind Mist:** blurs the village and garbles incoming chat. Light lanterns by number, not height. Level 1 has three short seals, each with lanterns 1, 2, 3, no decoys, a next-lantern hint, and forgiving wrong clicks. Level 2 has two seals with five numbers and one word decoy; level 3 has one seal with eight numbers and two decoys. Fog increases with the tier. Short lanterns in separated rows keep labels legible.
