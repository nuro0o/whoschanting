...
- **3–10 players**: 3–4 players have **1 cultist**, 5–6 have **2**, 7–8 have **3**, and 9–10 have **4**. Exactly one cultist is the Veilweaver; any remaining cultists are Acolytes. There is always one Oracle. A Warden joins at 5+ players and a Lamplighter at 7+ players, each replacing a Townsperson; remaining town seats stay Townspeople. Cultists know all their teammates. In 5–10-player matches they receive the same randomly selected mission. **Small Gathering (3–4 players)** gives the lone Veilweaver **A voice below**: each submitted chant advances the ritual by one step, even when investigated. The lobby previews the current roster and ritual goal before players ready up.
