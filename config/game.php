...
return [
    ...
    'characters' => [
        ...
        ['id' => 'fae_envoy', 'name' => 'The Thorn Envoy'],
        ['id' => 'drowned_diver', 'name' => 'The Deep Diver'],
        ['id' => 'relic_broker', 'name' => 'The Relic Broker'],
        ['id' => 'hollow_cantor', 'name' => 'The Hollow Cantor'],
        ['id' => 'carnival_ringmaster', 'name' => 'The Ringmaster'],
    ],
